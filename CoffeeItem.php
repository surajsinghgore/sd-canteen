...
<script>
    ...
    window.document.title = "SD CANTEEN | Coffee Item";
</script>
...
<div class="Status">
      <div class="banner1">
        <img src="https://res.cloudinary.com/dnxv21hr0/image/upload/v1681014250/banner3_xdfqnn.jpg" alt="Coffee Item Banner"  />
      </div>
...
$.ajax({
                    type: "POST", //type of method
                    url: "http://localhost/sd-canteen/clientApi/searchCoffeeCategory.php", //your page
                    data: {
                        loadPage: 'pageLoad'
                    }, // passing the values
                    success: function(res) {
...
$.ajax({
                    ...
                    data: {
                        id: itemId,category:'CoffeeItem',size:currentCategorySelected
                    }, 
                    // return data
                    success: function(res) {
...
for(let i=0;i<cartDataConvert1.items.length;i++){
    ...
    if(cartDataConvert1.items[i].itemMainCategory=="coffee"){
