...
<script>
    ...
    window.document.title = "SD CANTEEN | Juice Item";
</script>
...
<div class="Status">
      <div class="banner1">
        <img src="https://res.cloudinary.com/dnxv21hr0/image/upload/v1681014250/banner2_kqub4y.jpg" alt="Juice Item Banner"  />
      </div>
...
$.ajax({
                    ...
                    url: "http://localhost/sd-canteen/clientApi/searchJuiceItem.php", //your page
                    data: {
...
$.ajax({
                    type: "POST", //type of method
                    url: "http://localhost/sd-canteen/clientApi/searchJuiceCategory.php", //your page
                    data: {
                        loadPage: 'pageLoad'
                    }, // passing the values
                    success: function(res) {
...
$.ajax({
                    ...
                    data: {
                        id: itemId,category:'JuiceItem',size:currentCategorySelected
                    }, 
                    // return data
                    success: function(res) {
...
let cartDataConvert1=JSON.parse(cartData1);
for(let i=0;i<cartDataConvert1.items.length;i++){
    if(cartDataConvert1.items[i].itemMainCategory=="juice"){
