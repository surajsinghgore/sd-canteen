...
<script>
    window.document.title = "SD CANTEEN | Delete Drink Item";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure to delete this drink item ?
                </div>
                ...
                function deleteFoodItem() {
                    ...
                    if (sessionStorage.getItem('deleteDrinkItemId')) {
                        ...
                        $.ajax({
                            ...
                            url: "http://localhost/sd-canteen/api/deletedrinkitem.php", //your page
                            data: {
                                foodID: foodId
