...
<script>
    window.document.title = "SD CANTEEN | Delete Juice Item";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure to delete this juice item ?
                </div>
        ...
        <div class="rightsidebar">
            ...
            <div class="display_List">
                <div class="top">
                    ...
                    <div class="search">
                        <input type="search" name="name" placeholder="Search By Juice Name..." id="foodNameSearch" onkeyup="searchByName()" />
...
?>
                ...
                <div class="card_container" id="resultData">
                    <div class="cards">
                        ...
                        <li class="Item_Name" style="margin-left:6%;">Juice Name</li>
                    ...
                    require('../middleware/ConnectToDatabase.php');
                    $sql_query = "select * from juiceitems";
                    $resFoodItem = mysqli_query($connection, $sql_query);
...
<p>";
                            echo $FoodItemAllDataInAdmin['juicename'];
                            echo "</p></li>";
                            // food price
            ...
            <script>
                function deleteItem(id) {
                    sessionStorage.setItem('deleteDrinkItemId', id);
                ...
                function deleteFoodItem() {
                    ...
                    if (sessionStorage.getItem('deleteDrinkItemId')) {
                        let foodId = sessionStorage.getItem('deleteDrinkItemId');
                        $.ajax({
                            type: "POST", //type of method
                            url: "http://localhost/sd-canteen/api/deletejuiceitem.php", //your page
                            data: {
                                foodID: foodId
                            ...
                            success: function(res) {
                                ...
                                sessionStorage.removeItem('deleteDrinkItemId')
                            }
                        });
                ...
                function searchByCategory() {
                    ...
                    if (categorySelect == "no") {
                        ...
                        $.ajax({
                            type: "POST", //type of method
                            url: "http://localhost/sd-canteen/api/searchJuiceItemByCategory.php", //your page
                            data: {
                ...
                function searchByName() {
                    ...
                    $.ajax({
                        type: "POST", //type of method
                        url: "http://localhost/sd-canteen/api/searchJuiceItemByName.php", //your page
                        data: {
