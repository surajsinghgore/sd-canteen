...
<link rel="stylesheet" href="../styles/admin/ItemCategory.css?v=14">
<script>
    window.document.title = "SD CANTEEN | Manage Drink Category";
</script>
...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure to delete this drink category ?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No </button>
                    <button type="button" class="btn btn-primary" onclick="deleteDrinkCategoryFromDB()">Yes Delete
        ...
        <div class="rightsidebar">
            ...
            <div class="ListView">
                <div class="addCategory">
                    <a href="/sd-canteen/admin/adddrinkcategory.php">
                        <button>
                ...
                <div class="Subtop">
                    ...
                    <div class="searchBar">
                        <input type="search" name="searchdata" id="drinkCategoryNameSearch" onkeyup="searchByName()" placeholder="Search ..." />
                    </div>
                </div>
                <div class="ListData">
                    <div class="Heading">
                            ...
                            while ($FoodCategory = mysqli_fetch_array($resFoodCategory)) { ?>
                                <div class="DataLists" id="parent<?php echo $FoodCategory['id']; ?>">
                                    ...
                                    <div class="DropDown" id="dropdownmenu<?php echo $FoodCategory['id']; ?>" style="display:none;">
                                        <li class="Update" onclick='updateDrinkCategory("<?php echo $FoodCategory['id']; ?>")'>
                                            <i class="fa-solid fa-pen-to-square"></i>Update
                                        </li>

                                        <li class="delete" data-toggle="modal" data-target="#exampleModal" onclick='deleteDrinkCategory("<?php echo $FoodCategory['id']; ?>")'>
    ...
    <script>
        ...
        function searchByName() {
            ...
            let searchInput = document.getElementById('drinkCategoryNameSearch').value;

            $.ajax({
                type: "POST", //type of method
                url: "http://localhost/sd-canteen/api/searchdrinkcategorybyname.php", //your page
                data: {
                    drinkcategoryname: searchInput,
        ...
        const deleteDrinkCategoryFromDB = () => {
            let foodId = sessionStorage.getItem('updatedrinkitemid');
            $.ajax({
                type: "POST",
                url: "http://localhost/sd-canteen/api/deletedrinkcategory.php",
                data: {
                   drinkcategoryid: foodId

                }, // passing the values
                success: function(res) {
                    sessionStorage.removeItem('updatedrinkitemid');
