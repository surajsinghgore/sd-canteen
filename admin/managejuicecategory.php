...
<script>
    window.document.title = "SD CANTEEN | Manage Juice Category";
</script>
...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure to delete this juice category ?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No </button>
                    <button type="button" class="btn btn-primary" onclick="deleteJuiceCategoryFromDB()">Yes Delete
        ...
        <div class="rightsidebar">
            ...
            <div class="ListView">
                ...
                <div class="Subtop">
                    ...
                    <div class="searchBar">
                        <input type="search" name="searchdata" id="juiceCategoryNameSearch" onkeyup="searchByName()" placeholder="Search ..." />
                    </div>
                </div>
                <div class="ListData">
                    <div class="Heading">
                            ...
                            while ($FoodCategory = mysqli_fetch_array($resFoodCategory)) { ?>
                                <div class="DataLists" id="parent<?php echo $FoodCategory['id']; ?>">
                                    ...
                                    <div class="DropDown" id="dropdownmenu<?php echo $FoodCategory['id']; ?>" style="display:none;">
                                        <li class="Update" onclick='updateJuiceCategory("<?php echo $FoodCategory['id']; ?>")'>
    ...
    <script>
        ...
        function updateJuiceCategory(id) {

            sessionStorage.setItem('updatejuiceitemid', id);
            window.location.href = "http://localhost/sd-canteen/admin/updatejuicecategory.php";
        }
        ...
        function searchByName() {
            ...
            let searchInput = document.getElementById('juiceCategoryNameSearch').value;

            $.ajax({
                type: "POST", //type of method
                url: "http://localhost/sd-canteen/api/searchjuicecategorybyname.php", //your page
                data: {
                    juicecategoryname: searchInput,
        ...
        const deleteJuiceCategoryFromDB = () => {
            let foodId = sessionStorage.getItem('updatejuiceitemid');
            $.ajax({
                type: "POST",
                url: "http://localhost/sd-canteen/api/deletejuicecategory.php",
                data: {
                    juicecategoryid: foodId

                }, // passing the values
                success: function(res) {
                    sessionStorage.removeItem('updatejuiceitemid');
