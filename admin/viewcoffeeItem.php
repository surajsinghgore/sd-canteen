...
<script>
    window.document.title = "SD CANTEEN | Show Coffee Item";
            ...
            <div class="display_List">
                ...
                <div class="card_container" id="resultData">
                    <div class="cards">
                        ...
                        <li class="Item_Name">Coffee Name</li>
