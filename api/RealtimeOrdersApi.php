...
if (isset($_POST['completeOrders'])) {
    ...
    $currentDate = date("d-m-Y");
    $currentTime = date("h:i:s A");
  $query="select*from orderitems where orderstatus like 'complete' and orderdate like '$currentDate'  order by pickuptime24";
  $res=mysqli_query($connection, $query);
  $row=mysqli_num_rows($res);
...
// pending orders
  ...
  if (isset($_POST['pendingOrders'])) {
    ...
    $currentDate = date("d-m-Y");
    $currentTime = date("h:i:s A");
  $query="select*from orderitems where orderstatus like 'pending' and orderdate like '$currentDate'  order by pickuptime24";
  $res=mysqli_query($connection, $query);
  $row=mysqli_num_rows($res);
 ...
 <h6>No orders Found</h6>
  ...
  if (isset($_POST['rejectOrders'])) {
    ...
    $currentDate = date("d-m-Y");
    $currentTime = date("h:i:s A");
  $query="select*from orderitems where orderstatus like 'reject' and orderdate like '$currentDate'  order by pickuptime24";
  $res=mysqli_query($connection, $query);
  $row=mysqli_num_rows($res);
