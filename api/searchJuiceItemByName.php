...
if (isset($_REQUEST['deletepage'])) {
    ...
    $sql_query = "select * from juiceitems where juicename like '%$foodname%'";
    ...
    if ($length == 0) {
        ...
        while ($dataSearch = mysqli_fetch_array($resFoodItem)) { ?>
            <div class="dataCard" id="resultData">
                ...
                <li class="Item_Name">
                    <p><?php echo $dataSearch['juicename'] ?></p>
                </li>
...
// search by Id
    ...
    $sql_query = "select * from juiceitems where id=$FoodId";
