...
$input=$_POST['tokenId'];
        ...
        $query1="select*from paymentdata where orderId like '%$input%'";
        ...
        $query1="select*from orderitems where orderId like '%$input%'";
             $resQuery=mysqli_query($connection,$query1);
...
if(isset($_POST['customerName'])){
    $input=$_POST['customerName'];

            // paymentdata data fetch
                
            $query1="select*from paymentdata where fullname like '%$input%'";
            $resQuery1=mysqli_query($connection,$query1);
            ...
            $query1="select*from orderitems where fullname like '%$input%'";
                 $resQuery=mysqli_query($connection,$query1);
...
if(isset($_POST['totalAmount'])){
    $input=$_POST['totalAmount'];

            // payment data data fetch
                
            $query1="select*from paymentdata where totalamount=$input";
            $resQuery1=mysqli_query($connection,$query1);
            ...
            $query1="select*from orderitems where totalamount=$input";
                 $resQuery=mysqli_query($connection,$query1);
...
if(isset($_POST['TXNID'])){
    $input=$_POST['TXNID'];
            ...
            $query1="select*from paymentdata where txn_token like '%$input%'";
            $resQuery1=mysqli_query($connection,$query1);
            ...
            $query1="select*from orderitems where txn_token like '%$input%'";
                 $resQuery=mysqli_query($connection,$query1);
