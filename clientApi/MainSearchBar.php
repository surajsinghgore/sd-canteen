...
if (isset($_REQUEST['searchBarInput'])) {
    ...
    while ($FoodData = mysqli_fetch_array($res1)) { ?>
        ...
        <a href="/sd-canteen/items.php?itemname=<?php echo $FoodData['foodname']; ?>">
            <li onclick='searchClick("<?php echo $FoodData['foodname']; ?>")'><i class="fa-solid fa-magnifying-glass fixed"></i><?php echo $FoodData['foodname']; ?></li>
        </a>
