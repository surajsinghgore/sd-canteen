...
<?php
 ...
 <li  onclick='loadParticularCategory("<?php echo $allCategoryData['coffeecategoryname'];?>")'><span class="heading">
    ...
    <?php echo $allCategoryData['coffeecategoryname'];?></span>

    <!-- count food in category -->
    <span class="length"> <?php 
    $countLength = "select * from coffeeitems where category='".$allCategoryData['coffeecategoryname']."' and active='on'";
...
$food_item_count = "select * from coffeeitems where active='on' and category like '$category'";
$res_food_item_count = mysqli_query($connection, $food_item_count);
$FoodItemsCount = mysqli_num_rows($res_food_item_count);
