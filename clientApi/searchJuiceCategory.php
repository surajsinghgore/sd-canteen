...
if (isset($_REQUEST['loadPage'])) {
    ...
    $food_item_count = "select * from juiceitems where active='on'";
...
<?php
 ...
 <li  onclick='loadParticularCategory("<?php echo $allCategoryData['juicecategoryname'];?>")'><span class="heading">
    ...
    <?php echo $allCategoryData['juicecategoryname'];?></span>

    <!-- count food in category -->
    <span class="length"> <?php 
    $countLength = "select * from juiceitems where category='".$allCategoryData['juicecategoryname']."' and active='on'";
...
$food_item_count = "select * from juiceitems where active='on' and category like '$category'";
$res_food_item_count = mysqli_query($connection, $food_item_count);
$FoodItemsCount = mysqli_num_rows($res_food_item_count);
...
if($FoodItemsCount>0){
    ...
    <div class="FoodImg">
    <a href="/sd-canteen/items.php?itemname=<?php echo $allFoodData['juicename'];?>">
    <img src="<?php 
    ...
    <div class="deatils">
    <a href="/sd-canteen/items.php?itemname=<?php echo $allFoodData['juicename'];?>"><h1><?php echo $allFoodData['juicename'];?></h1></a>
    ...
    onclick='removeFromCart("<?php echo $allFoodData['id'];?>","<?php echo $allFoodData['juicename'];?>")'
    >Remove Item</button>
    
    <!-- add to cart -->
    <button onclick='addToCart("<?php echo $allFoodData['id'];?>","<?php echo $allFoodData['juicename'];?>")' id="addToCartBtn<?php echo $allFoodData['id'];?>">Add To Cart</button>
    
    <!-- buy now button -->
    <button class="buy" onclick='addToCartAndBuy("<?php echo $allFoodData['id'];?>","<?php echo $allFoodData['juicename'];?>")'>Buy Now</button>
    </div>
