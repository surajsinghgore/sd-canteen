...
<script>
    ...
    window.document.title = "SD CANTEEN | Term and condition";
</script>
...
<h5>You must not:</h5>
<p>
<li>Republish food from sdcanteen.com</li>
<li>Sell, rent or sub-license food from sdcanteen.com</li>
<li>Reproduce, duplicate or copy food from sdcanteen.com</li>
<li>Redistribute content from sdcanteen.com</li>
This Agreement shall begin on the date hereof.<br/>
Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. sdcanteen does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of sdcanteen,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, sdcanteen shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website. sdcanteen reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
</p>
...
You hereby grant Codeswear a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
</p>
...
<li>sdcanteen.com community sites;</li>
...
<p>Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.</p>
 ...
 <h3>Orders</h3>
  <p>We will try our best to confirm 100% of the orders but in an uncertain event if we are being not able to fulfil the order, we may attempt to notify you by contacting the e-mail and/or billing address/phone number provided at the time the order was made.
...
Our obligations under these Terms shall cease for the period of Force Majeure, and shall resume on the date such Force Majeure event actually ends, whether or not this is the same as the tentative date.</p>
...
<li>exclude any of our or your liabilities that may not be excluded under applicable</li>
