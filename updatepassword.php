...
<?php 
     ...
     require('./clientApi/updatepassword.php');
...
<link rel="stylesheet" href="./styles/client/ClientPanel.css?v=3">
...
<script>
    ...
    window.document.title="SD CANTEEN | Change Password ";
</script>
<body>
    <div class="admin">
...
<a href="/sd-canteen/updateclientprofile.php">
          ...
          <div class="links">
            <li>
              ...
              <div class="text"><a href="/sd-canteen/clientpanel.php">General</a></div>
            </li>
        ...
        <div class="password">
              ...
              <div class="forms">
                ...
                <li>
                  <button name="change_current_password">Change Password</button>
                </li>
                </form>
            </div>
            </div>
